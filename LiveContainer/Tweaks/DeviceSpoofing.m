...
NSDictionary<NSString *, NSDictionary *> *LCGetAvailableDeviceProfiles(void) {
    return @{
        @"iPhone 17 Pro Max": @{@"model": @"iPhone18,2", @"version": @"26.3", @"memory": @"12 GB", @"chip": @"A19 Pro"},
        @"iPhone 17 Pro": @{@"model": @"iPhone18,1", @"version": @"26.3", @"memory": @"12 GB", @"chip": @"A19 Pro"},
        @"iPhone 17": @{@"model": @"iPhone18,3", @"version": @"26.3", @"memory": @"8 GB", @"chip": @"A19"},
        @"iPhone 17 Air": @{@"model": @"iPhone18,4", @"version": @"26.3", @"memory": @"12 GB", @"chip": @"A19 Pro"},
